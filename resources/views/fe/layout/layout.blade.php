                                       ...
                                       <li>
                                          <div class="container">
                                             ...
                                             <div class="row menu-banner">
                                                <div class="col-lg-6">
                                                   <div>
                                                      <img src="../assets/images/layout-5/menu-banner/1.jpg" alt="menu-banner" class="img-fluid">
                                                   </div>
                                                </div>
                                                <div class="col-lg-6">
                                                   <div>
                                                      <img src="../assets/images/layout-5/menu-banner/2.jpg" alt="menu-banner" class="img-fluid">
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                                          ...
                                          <div class="container">
                                             <div class="row">
                                                ...
                                                <div class="col mega-box product ">
                                                   <div class="mega-img">
                                                      <img src="../assets/images/layout-5/menu-banner/3.jpg" alt="menu-banner" class="img-fluid">
                                                   </div>
                                                </div>
                                             </div>
                                          </div>
                              ...
                              <div class="nav-left">
                                 ...
                                 <div class="collapse hide nav-desk" id="navbarToggleExternalContent">
                                    <ul class="nav-cat title-font">
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/01.png " alt="catergory-product"> western ware</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/02.png " alt="catergory-product"> TV, Appliances</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/03.png " alt="catergory-product"> Pets Products</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/04.png " alt="catergory-product"> Car, Motorbike</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/05.png " alt="catergory-product"> Industrial Products</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/06.png " alt="catergory-product"> Beauty, Health Products</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/07.png " alt="catergory-product"> Grocery Products </a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/08.png " alt="catergory-product"> Sports</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/09.png " alt="catergory-product"> Bags, Luggage</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/10.png " alt="catergory-product"> Movies, Music </a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/11.png " alt="catergory-product"> Video Games</a></li>
                                       <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/08.png " alt="catergory-product"> Sports</a></li>
                                       <li class="mor-slide-open">
                                          <ul>
                                             <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/08.png " alt="catergory-product"> Sports</a></li>
                                             ...
                                             <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/10.png " alt="catergory-product"> Movies, Music </a></li>
                                             <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/11.png " alt="catergory-product"> Video Games</a></li>
                                             <li><a href="category-page(left-sidebar).html"> <img src="../assets/images/layout-1/nav-img/12.png " alt="catergory-product"> Toys, Baby Products</a></li>
                                          </ul>
                                       </li>
                        ...
                        <div>
                            <div class="product-box">
                                <div class="product-imgbox">
                                    ...
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="../assets/images/layout-5/product/8.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart" >
                        ...
                        <div>
                            <div class="product-box">
                                <div class="product-imgbox">
                                    ...
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="../assets/images/layout-5/product/9.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart" >
                        ...
                        <div>
                            <div class="product-box">
                                <div class="product-imgbox">
                                    ...
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="../assets/images/layout-5/product/10.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart" >
                        ...
                        <div>
                            <div class="product-box">
                                <div class="product-imgbox">
                                    ...
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="../assets/images/layout-5/product/11.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart" >
                        ...
                        <div>
                            <div class="product-box">
                                <div class="product-imgbox">
                                    ...
                                    <div class="product-back">
                                        <a href="product-page(left-sidebar).html">
                                            <img src="../assets/images/layout-5/product/12.jpg" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    <div class="product-icon icon-inline">
                                        <button data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart" >
    ...
    <section class="services services-inverse">
        <div class="container">
            <div class="row service-block">
                ...
                <div class="col-lg-3 col-md-6  col-sm-12 ">
                    <div class="media">
                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 295.82 295.82" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 295.82 295.82"> <g> <g> <path d="m269.719,43.503h-243.617c-13.921,0-26.102,12.181-26.102,26.102v156.611c0,13.921 12.181,26.102 26.102,26.102h243.617c13.921,0 26.102-12.181 26.102-26.102v-156.611c-0.001-13.921-12.182-26.102-26.102-26.102zm-243.617,17.401h243.617c5.22,0 8.701,3.48 8.701,8.701v13.921h-261.019v-13.921c-1.06581e-14-5.22 3.481-8.701 8.701-8.701zm252.317,40.023v13.921h-261.018v-13.921h261.018zm-8.7,133.989h-243.617c-5.22,0-8.701-3.48-8.701-8.701v-93.966h261.018v93.966c0,5.221-3.48,8.701-8.7,8.701z"/> <path d="m45.243,172.272h45.243c5.22,0 8.701-3.48 8.701-8.701 0-5.22-3.48-8.701-8.701-8.701h-45.243c-5.22,0-8.701,3.48-8.701,8.701 0.001,5.221 3.481,8.701 8.701,8.701z"/> <path d="m151.391,191.413h-106.148c-5.22,0-8.701,3.48-8.701,8.701s3.48,8.701 8.701,8.701h106.147c3.48,0 8.701-3.48 8.701-8.701s-3.48-8.701-8.7-8.701z"/> </g> </g> </svg>
                        <div class="media-body">
                            <h5>EASY RETURN</h5>
                        </div>
                    </div>
        ...
        <div class="news-latter">
          <div class="modal-bg">
            ...
            <div class="imd-wrraper">
                <img src="../assets/images/layout-5/blog/2.jpg" alt="newsletterimg" class="img-fluid bg-img">
            </div>
            </div>
          </div>
        </div>
    ...
    <div class="cart_media">
      <ul class="cart_product">
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="../assets/images/layout-5/product/1.jpg">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="../assets/images/layout-5/product/2.jpg">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="../assets/images/layout-5/product/3.jpg">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
                <h4>vivo y30</h4>
